...
namespace Assets.Project.Turn_Management.POC_States
{
    public class WaitTurnState : BaseTurnState
    {
        ...
        public override void HandleTurnStateEvent(TurnStateMachineManager manager, TurnStateMachineManagerEventType eventType)
        {
